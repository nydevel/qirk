...
import org.wrkr.clb.chat.repo.mariadb.MariaDBProjectMessageRepo;
import org.wrkr.clb.common.crypto.token.chat.ChatTokenData;


@Service
public class MariaDBProjectChatService extends MariaDBAttachedChatService {

    @Autowired
    private MariaDBProjectMessageRepo messageRepo;
