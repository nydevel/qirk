...
import org.wrkr.clb.chat.repo.cassandra.CassandraTaskMessageRepo;
import org.wrkr.clb.common.crypto.token.chat.ChatTokenData;


@Service
public class CassandraTaskChatService extends CassandraAttachedChatService {

    @Autowired
    private CassandraTaskMessageRepo messageRepo;
    ...
    protected BaseChatMessage createMessageInstance(ChatTokenData tokenData, String message, UUID uuid,
        ...
        taskMessage.setTimestamp(timestamp);
