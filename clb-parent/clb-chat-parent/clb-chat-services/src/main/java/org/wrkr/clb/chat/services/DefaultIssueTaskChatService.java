...
import org.wrkr.clb.chat.services.cassandra.CassandraIssueChatService;
import org.wrkr.clb.chat.services.mariadb.MariaDBChatService;
import org.wrkr.clb.chat.services.mariadb.MariaDBIssueChatService;
...
public class DefaultIssueTaskChatService extends DefaultChatService implements IssueChatService {
    ...
    @Autowired
    private CassandraIssueChatService cassandraService;

    @Deprecated
    @Autowired(required = false)
    private MariaDBIssueChatService mariaDBService;
