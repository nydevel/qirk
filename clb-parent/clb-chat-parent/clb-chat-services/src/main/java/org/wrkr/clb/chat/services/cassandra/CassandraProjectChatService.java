...
import org.wrkr.clb.chat.repo.cassandra.CassandraProjectMessageRepo;
import org.wrkr.clb.common.crypto.token.chat.ChatTokenData;


@Service
public class CassandraProjectChatService extends CassandraAttachedChatService {

    @Autowired
    private CassandraProjectMessageRepo messageRepo;
    ...
    protected BaseChatMessage createMessageInstance(ChatTokenData tokenData, String message, UUID uuid,
        ...
        projectMessage.setUuid(uuid);
        projectMessage.setTimestamp(timestamp);
