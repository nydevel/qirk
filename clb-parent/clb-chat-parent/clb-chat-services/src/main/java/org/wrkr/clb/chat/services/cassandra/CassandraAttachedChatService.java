...
import org.wrkr.clb.chat.repo.cassandra.BaseAttachedChatMessageRepo;
import org.wrkr.clb.chat.services.dto.MessageDTO;
import org.wrkr.clb.common.crypto.token.chat.ChatTokenData;

public abstract class CassandraAttachedChatService extends CassandraChatService {

    @Override
    public List<MessageDTO> getLastMessages(ChatTokenData tokenData, long timestamp) {
        List<BaseChatMessage> messageList = ((BaseAttachedChatMessageRepo) getRepo()).listTopSinceTimestampByChatId(
                tokenData.chatId, timestamp,
