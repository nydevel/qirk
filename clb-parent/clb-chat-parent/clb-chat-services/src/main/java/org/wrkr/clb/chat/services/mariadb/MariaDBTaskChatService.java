...
import org.wrkr.clb.chat.repo.mariadb.MariaDBTaskMessageRepo;
import org.wrkr.clb.common.crypto.token.chat.ChatTokenData;


@Service
public class MariaDBTaskChatService extends MariaDBAttachedChatService {

    @Autowired
    private MariaDBTaskMessageRepo messageRepo;
