...
import org.wrkr.clb.chat.model.mariadb.TaskMessage;
import org.wrkr.clb.chat.model.mariadb.TaskMessage_;


@Repository
public class MariaDBTaskMessageRepo extends BaseAttachedChatMessageRepo {

    @SuppressWarnings("unused")
    private static final Logger LOG = LoggerFactory.getLogger(MariaDBTaskMessageRepo.class);
