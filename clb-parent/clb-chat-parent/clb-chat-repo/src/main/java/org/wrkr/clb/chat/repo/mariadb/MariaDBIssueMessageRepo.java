...
@Repository
public class MariaDBIssueMessageRepo extends BaseAttachedChatMessageRepo {

    @SuppressWarnings("unused")
    private static final Logger LOG = LoggerFactory.getLogger(MariaDBIssueMessageRepo.class);
