...
public class SecurityTaskHashtagWithProjectAndMembershipMapper extends SecurityTaskHashtagWithProjectMapper {
    ...
    public SecurityTaskHashtagWithProjectAndMembershipMapper(String hashtagTableName, String projectTableName,
            String orgMemberTableName, String projectMemberTableName) {
        super(hashtagTableName);
        this.projectMapper = new SecurityProjectWithMembershipMapper(projectTableName,
