...
public class NotificationDTO {
    ...
    public static NotificationDTO fromRow(Row row) {
        return new NotificationDTO(
                row.getLong(Notification_.timestamp),
                row.getString(Notification_.notificationType),
                row.getString(Notification_.json));
    }
