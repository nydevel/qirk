...
public abstract class BaseVersionedEntityService {

    protected <E extends BaseVersionedEntity> E checkRecordVersion(E entity, Long recordVersion) throws ConflictException {
