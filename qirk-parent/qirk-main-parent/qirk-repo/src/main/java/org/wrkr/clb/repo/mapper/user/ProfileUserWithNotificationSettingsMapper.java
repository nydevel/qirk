...
public class ProfileUserWithNotificationSettingsMapper extends ProfileUserMapper {

    private NotificationSettingsMapper notificationSettingsMapper;

    public ProfileUserWithNotificationSettingsMapper(String userTableName, String notifSettingsTableName) {
        super(userTableName);
