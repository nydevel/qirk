...
@Repository
public abstract class JPABaseIdRepo<E extends BaseIdEntity> extends JPABaseMainRepo<E> {

    private static final Logger LOG = LoggerFactory.getLogger(JPABaseIdRepo.class);
