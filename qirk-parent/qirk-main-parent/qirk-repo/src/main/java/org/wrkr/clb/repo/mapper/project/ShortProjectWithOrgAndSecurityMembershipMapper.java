...
public class ShortProjectWithOrgAndSecurityMembershipMapper extends ShortProjectMapper {

    private OrganizationMapper organizationMapper;
    private OrganizationMemberWithProjectMemberMapper organizationMemberMapper;

    public ShortProjectWithOrgAndSecurityMembershipMapper(String projectTableName, String orgTableName,
            String orgMemberTableName, String projectMemberTableName) {
        super(projectTableName);
        this.organizationMapper = new OrganizationMapper(orgTableName);
    ...
    public Project mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        organization.setMembers(project.getOrganizationMembers());
