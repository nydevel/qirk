package org.wrkr.clb.repo.project.roadmap;
...
@Repository
public class RoadRepo extends JDBCIdEntityRepo {
    ...
    private static final VersionedEntityMapper<Road> RECORD_VERSION_MAPPER = new VersionedEntityMapper<Road>() {
