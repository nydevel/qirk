...
public class ShortProjectWithShortOrgMapper extends ShortProjectMapper {

    private ShortOrganizationMapper organizationMapper = new ShortOrganizationMapper();

    public ShortProjectWithShortOrgMapper(String projectTableName, String orgTableName) {
        super(projectTableName);
        organizationMapper = new ShortOrganizationMapper(orgTableName);
    }
